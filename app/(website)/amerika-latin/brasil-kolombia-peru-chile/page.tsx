...
export const metadata = latinAmericaMetadata(`${programme.title} 2027`, `${detail.duration}. Estimasi mulai ${rupiahMillions(detail.price.from)} per orang termasuk tiket Jakarta PP dan regional. Harga untuk 20 peserta; pilihan 10/15 peserta dan land tour only tanpa tiket pesawat tersedia.`, programme.href);
