    ...
    <div className={styles.page} id="main-content">
      ...
      <section className={styles.catalogHero}>
        ...
        <div className={styles.shell}>
          ...
          <p className={styles.caption}>Pilih paket dengan tiket pesawat dari Jakarta atau land tour only. Keduanya mencakup hotel dan tour leader Indonesia. Tersedia pilihan untuk grup 10, 15, atau 20 peserta.</p>
        </div>
      </section>
