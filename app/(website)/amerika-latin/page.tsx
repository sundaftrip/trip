    ...
    <div className={styles.page} id="main-content">
      ...
      <section className={styles.catalogHero}>
        ...
        <div className={styles.shell}>
          ...
          <p className={styles.caption}>Itinerary, hotel, dan estimasi harga dengan anggaran tiket Jakarta PP. Acuan 20 peserta + 1 tour leader; tanggal dan harga akhir dikonfirmasi melalui penawaran.</p>
        </div>
      </section>
      ...
      <section className={`${styles.section} ${styles.shell}`} lang="en" aria-labelledby="trade-catalog-heading"><div className={styles.sectionIntro}><p className={styles.eyebrow}>TRAVEL TRADE ENQUIRIES</p><h2 id="trade-catalog-heading">Sundaf Trip, Indonesia</h2><p>Our 2027 catalogue presents a seven-day Peru programme and a thirteen-day Brazil, Colombia, Peru and Chile programme. Published retail estimates include airfare allowances from Jakarta and the allocation for one tour leader across 20 paying guests.</p><p>We have sourced regional supplier proposals since August 2026. The catalogue is open for enquiries; current group rates, dates, services and availability are reconfirmed in a written quotation before booking. Sundaf Trip operates under CV Sundaf Holiday Group.</p><div className={styles.actions}><Link scroll data-scroll-reset-after-navigation href="/company-profile" className={styles.textLink}>Company profile <ArrowUpRight size={17} aria-hidden="true" /></Link><a href="mailto:info@sundaftrip.com?subject=Peru%20and%20South%20America%202027%20trade%20enquiry" className={styles.textLink}>info@sundaftrip.com <ArrowUpRight size={17} aria-hidden="true" /></a></div></div></section>
