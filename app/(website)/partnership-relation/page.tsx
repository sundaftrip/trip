...
export const metadata: Metadata = {
  title: "Tyas - Partnership Relation Sundaf Trip",
  description:
    "Meet Tyas from the Partnership Relation team at Sundaf Trip for suppliers, DMCs, hotels, transportation providers, guides, restaurants, and operational partners.",
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: "Tyas - Partnership Relation Sundaf Trip",
    description:
      "Official Partnership Relation contact at Sundaf Trip for suppliers and DMCs who want to introduce their services for potential collaboration.",
    url: PAGE_URL,
    ...
    "@graph": [
      {
        ...
        "@id": `${PAGE_URL}#webpage`,
        url: PAGE_URL,
        name: "Tyas - Partnership Relation Sundaf Trip",
        description:
          "Meet Tyas from the Partnership Relation team at Sundaf Trip for suppliers, DMCs, hotels, transportation providers, guides, restaurants, and operational partners.",
        ...
        <div className="relative mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.02fr_0.98fr] lg:px-8 lg:py-20">
          <div className="flex flex-col justify-center">
            ...
            <h1 className={`text-4xl font-bold leading-tight sm:text-5xl lg:text-6xl ${lora.className}`}>
              Hello, I&apos;m Tyas from the Partnership Relation team at Sundaf Trip.
            </h1>
            <p className="mt-5 max-w-2xl text-base leading-relaxed text-gray-600 dark:text-gray-300 sm:text-lg">
              I support our team in establishing professional communication with suppliers, DMCs, hotels, transportation providers, restaurants, guides, and operational partners.
            </p>
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-gray-600 dark:text-gray-300 sm:text-lg">
              I&apos;m reaching out to better understand your services and explore potential collaboration opportunities with Sundaf Trip.
            </p>
          ...
          <div className="grid gap-3 sm:grid-cols-[0.9fr_1.1fr]">
            <div className="flex min-h-[320px] flex-col justify-between rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-slate-900">
              ...
              <div className="mt-8 grid gap-2 text-sm text-gray-600 dark:text-gray-300">
                ...
                <span className="inline-flex items-center gap-2"><Building2 size={15} /> CV Sundaf Holiday Group</span>
              </div>
            </div>
