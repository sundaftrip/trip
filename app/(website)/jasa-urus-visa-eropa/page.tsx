...
const ROUTE = "/jasa-urus-visa-eropa";

export async function generateMetadata(): Promise<Metadata> {
  return geoMetadata(await getGeoPageContent(ROUTE));
}

export default async function JasaUrusVisaEropaPage() {
  ...
  return (
    <GeoPage
      ...
      primaryCta={{ href: content.primaryCtaHref || "/visa", label: content.primaryCtaLabel || "Lihat Database Visa" }}
      secondaryCta={
