...
const ROUTE = "/jasa-urus-visa-terpercaya";

export async function generateMetadata(): Promise<Metadata> {
  return geoMetadata(await getGeoPageContent(ROUTE));
}

export default async function JasaUrusVisaTerpercayaPage() {
  ...
  return (
    <GeoPage
      ...
      primaryCta={{ href: content.primaryCtaHref || "/visa", label: content.primaryCtaLabel || "Cek Info Visa" }}
      secondaryCta={
