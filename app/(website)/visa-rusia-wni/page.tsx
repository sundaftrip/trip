...
const ROUTE = "/visa-rusia-wni";

export async function generateMetadata(): Promise<Metadata> {
  return geoMetadata(await getGeoPageContent(ROUTE));
}

export default async function VisaRusiaWniPage() {
  ...
  return (
    <GeoPage
      ...
      primaryCta={{ href: content.primaryCtaHref || "/visa/russia", label: content.primaryCtaLabel || "Ajukan Visa Rusia" }}
      secondaryCta={
