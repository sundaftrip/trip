...
export const metadata = latinAmericaMetadata(`${programme.title} 2027`, `${detail.duration}. Estimasi mulai ${rupiahMillions(detail.price.from)} per orang, termasuk tiket Jakarta PP. Harga untuk 20 peserta; tersedia pilihan 10 dan 15 peserta.`, programme.href);
