...
const THEMES = [
  ...
  { key: "corei",    label: "Corei",     desc: "Kawaii hangat untuk klien CORE. Pastel peach + aksen burnt orange, kartu rounded dengan shadow lembut, ikon hati & sparkles.", feature: null },
