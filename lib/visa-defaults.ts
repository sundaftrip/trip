...
const WAJIB: VisaDefaults = {
  ...
  documents: [
    ...
    { name: "Rekening koran 3 bulan", hint: "Saldo terlihat stabil, bukan deposit mendadak." },
    { name: "Tiket pulang (booking)", hint: "Belum lunas tidak masalah — yang penting ada bukti rencana." },
    { name: "Booking hotel / akomodasi", hint: "Bisa free-cancel di Booking.com kalau belum yakin." },
