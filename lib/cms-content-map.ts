...
export const CMS_CONTENT_MAP: CmsContentArea[] = [
  ...
  { area: "Footer dan kontak perusahaan", publicPath: "/contact", controls: [{ label: "Pengaturan", href: "/admin/settings" }, { label: "Teks Website", href: "/admin/texts" }], note: "Identitas badan usaha, alamat, kontak, logo, dan jam layanan di Pengaturan; paragraf footer aktif serta label, judul, dan paragraf pembuka halaman kontak di Teks Website. Arsip kontak tidak mengubah pembuka aktif. Metadata dan menu navigasi masih tetap." },
