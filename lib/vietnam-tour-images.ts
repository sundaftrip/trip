...
const HERO_BY_SLUG: Record<string, string> = {
  ...
  "4d3n-central-vietnam": imageUrl("da-nang", "sun-world-cable-car.webp"),
  ...
  "7d6n-northern-and-central-vietnam": imageUrl("halong-bay", "ha-long-view.webp"),
  "7d6n-northern-and-southern-vietnam": imageUrl("ninh-binh", "mua-cave.webp"),
  "7d6n-vietnam-from-north-to-south": imageUrl("da-nang", "golden-bridge-sunset.webp"),
  ...
  "8d7n-vietnam-south-to-north": imageUrl("mekong-delta", "delta-sunset.webp"),
  ...
  "10d9n-vietnam-from-north-to-south": imageUrl("phu-quoc", "sao-beach.webp"),
