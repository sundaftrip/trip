...
export default function AdminShell({ role, user, children }: Props) {
        ...
        <div className="lg:hidden fixed inset-0 z-40 flex">
          ...
          <aside className="relative z-50 w-72 bg-white dark:bg-gray-800 flex flex-col h-full shadow-xl">
            <div className="h-16 flex items-center justify-between px-6 border-b border-gray-200 dark:border-gray-700">
              <Image src="/logo.png" alt="Sundaf" width={100} height={30} className="h-7 w-auto dark:brightness-0 dark:invert" />
