...
export default function ImageUpload({ value, onChange, folder = "travel", multiple = false, uploadLabel }: Props) {
        ...
        <div>
          ...
          {mode === "upload" ? (
            <div>
              ...
              >
                <Upload size={16} />
                {uploading ? progress || "Mengupload..." : uploadLabel ?? (multiple ? "Upload Gambar" : "Upload Gambar Hero")}
              </button>
            </div>
          ) : (
